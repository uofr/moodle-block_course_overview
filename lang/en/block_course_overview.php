...
$string['privacy:metadata:sortorder'] = 'Sort by:';
$string['removefavourite'] = 'Remove favourite';
$string['reorderfullname'] = 'Course Name';
$string['reorderid'] = 'Course ID';
$string['reordernone'] = 'Custom (Drag and Drop)';
$string['reordershortname'] = 'Course short name';
$string['reorderstartdate'] = 'Start Date';
$string['reorderenddate'] = 'End Date';
$string['reorderrecent'] = 'Recently Accessed';
...
$string['userchoosezero'] = 'Default ({$a})';
$string['usersetmaxcourses'] = "Show:";
